...
#### (b) Join attribute & geospatial data
...
In the code chunk below, *tm_compass()*, *tm_scalebar()* and *tm_grid()* are used to add compass, scale bar and grid lines onto the choropleth map.
...
## 4 **Drawing Small Multiple Choropleth Maps**
...
We can also facet the chart using tm_polygons().
...
## 5 **Mapping Spatial Object Meeting a Selection Criterion**
